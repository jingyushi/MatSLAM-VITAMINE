...
%           obj.detectorParameter.localMaximaWindowSize = min(floor(imgsize(1)/12),floor(imgsize(2)/12));
       ...
       function r = updateDetector(obj,inputImage)
           ...
           obj.affineb = double(obj.affineTransformation.T(3,1:2))*3;
%            A = obj.affineTransformation.T
           ...
           [obj.worldPoints,obj.reproErrors,obj.proposed_orientation,obj.proposed_location] = obj.triangulateValidPoints();
           obj.previousImage = obj.inputImage;
           r = obj;
       end
       
       function r = updateCamera(obj,orientation,location)
           obj.orientation = orientation;
           obj.location = location;
           obj.cameraMatrix = cameraMatrix(obj.detectorParameter.cameraParameter, obj.orientation, obj.location);
...
%                obj.pointsToPredict(validPoints,2)]; 
       ...
       function [rotation, translation,inliersXt0,inliersXt1] = poseEstimation(obj)
...
%             featurePoints_xt0 = featurePoints_xt0*3; %unsample coordinates
%             featurePoints_xt1 = obj.matchesInCurrentFrame.Location;
%             featurePoints_xt1 = featurePoints_xt1*3;
%             [M,inliersIndex] = estimateEssentialMatrix(featurePoints_xt0,featurePoints_xt1,...
%                obj.detectorParameter.cameraParameter,'Confidence',95,'MaxDistance',0.5,'MaxNumTrials',2000);
...
%             imshow(im);
%             hold on;
%             for ii = 1:length(inliersXt0(:,1))
%                 x1 = inliersXt1(ii,1);
%                 x2 = inliersXt0(ii,1);
%                 y1 = inliersXt1(ii,2);
%                 y2 = inliersXt0(ii,2)+length(obj.resizedInputImage(:,1));
...
%             hold off;
       ...
       function [worldPoints,reproErrors,proposed_orietation,proposed_location] = triangulateValidPoints(obj)
           projMatrix1 = obj.cameraMatrix;%3*4 to 4*3?
           %projMatrix2 = cameraMatrix(obj.detectorParameter.cameraParameter,obj.rotation,obj.translation);
           proposed_orietation = obj.orientation*obj.rotation;
           proposed_location = obj.location+obj.translation;
           projMatrix2 = cameraMatrix(obj.detectorParameter.cameraParameter,...
               proposed_orietation,proposed_location);
           [worldPoints,reproErrors] = triangulate(obj.inliersXt0,obj.inliersXt1,projMatrix1,projMatrix2);
           %error = reproErrors
       end
   end
end
