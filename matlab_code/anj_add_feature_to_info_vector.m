...
function features_info = anj_add_feature_to_info_vector( uv, X_RES, features_info, step, newFeature)
...
%features_info(new_position).feature = feature;
%features_info(new_position).discriptor = descriptor;