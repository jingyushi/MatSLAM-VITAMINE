...
% im_fig2 = subplot('position',[0.05 0.1 0.425 0.8]);
% dist_stat = subplot('position',[0.05 0.1 0.425 0.8]);
im_fig = subplot(1,2,1);
near3D_fig = subplot(1,2,2);
% im_fig = subplot(2,2,1);
% near3D_fig = subplot(2,2,4);
% im_fig2 = subplot(2,2,2);
% dist_stat = subplot(2,2,3);
view(-180,0);